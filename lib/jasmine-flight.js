...
+function (root, jasmine, $) {
  ...
  // Support Webpack as RequireJS alternative by detecting a webpack-only feature
  ...
  function describeComponentFactory (componentReference, specDefinitions, isMixin) {
    return function () {
      beforeEach(function (done) {
        ...
        // async loading for RequireJS, sync preprocessing for Webpack
        if (isWebpack) {
          requireCallback(registry, defineComponent, componentReference);
        } else {
          require(['flight/lib/registry', 'flight/lib/component', componentReference], requireCallback);
        }
      });
      ...
      afterEach(function (done) {
        ...
        if (isWebpack) {
          requireCallback(defineComponent);
        } else {
  ...
  function describeModuleFactory (moduleReference, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        ...
        if (isWebpack) {
          requireCallback(moduleReference);
        } else {
