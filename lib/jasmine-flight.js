...
+function (root, jasmine, $) {
  ...
  var describeComponentFactory = function (componentReference, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        ...
        if (isWebpack) {
          ...
          require(['flight/lib/registry', componentReference], requireCallback);
        }
      });
  ...
  var describeMixinFactory = function (mixinReference, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        this.Component = this.component = this.$node = null;
        ...
        if (isWebpack) {
          registry.reset();
          this.Component = defineComponent(function () {}, mixinReference);
          done();
        } else {
          ...
          require(['flight/lib/registry', 'flight/lib/component', mixinReference], requireCallback);
        }
      });
  ...
  jasmine.Env.prototype.describeModule = function (moduleReference, specDefinitions) {
    describe(moduleReference, function () {
      beforeEach(function (done) {
        this.module = null;
        ...
        if (isWebpack) {
          ...
          require([moduleReference], requireCallback);
        }
      });
